...
myApp.controller('ListController',function ($scope,$http,$log) {
    ...
    //薪资筛选
    $scope.salary= function (val) {
        switch (val){
            case 0:
                var args={price:'0,1000'};
                loadListData(args);
                break;
            case 1:
                var args={price:'1000,2000'};
                loadListData(args);
                break;
            case 2:
                var args={price:'2000,3000'};
                loadListData(args);
                break;
            case 3:
                var args={price:'3000,4000'};
                loadListData(args);
                break;
            case 4:
                var args={price:'4000,5000'};
                loadListData(args);
                break;
            case 5:
                var args={price:'5000,6000'};
                loadListData(args);
                break;
            case 6:
                var args={price:'6000,7000'};
                loadListData(args);
                break;
        }
    }
